...
int main()
{
	...
	Shader lightingShader("shaders\\Multiple lights.vs", "shaders\\Multiple lights.frag");
	...
	unsigned char* image;
	// Diffuse map
	image = SOIL_load_image("resources\\textures\\container2.png", &width, &height, 0, SOIL_LOAD_RGB);
	...
	// Specular map
	image = SOIL_load_image("resources\\textures\\container2_specular.png", &width, &height, 0, SOIL_LOAD_RGB);
	...
	glDeleteShader(lightingShader.Program);
	glDeleteShader(lampShader.Program);
