...
int main()
{
	...
	Shader lightingShader("shaders\\DirectionalLight.vs", "shaders\\DirectionalLight.frag");
	Shader lampShader("shaders\\BasicColorLamp.vs", "shaders\\BasicColorLamp.frag");
	...
	//	glUniform3f(lightPosLoc, lightPos.x, lightPos.y, lightPos.z);
		...
		glm::vec3 ligPos(2.3f,-1.7f,1.6);
		ligPos.x = 10 - sqrt(ligPos.z*lightPos.z + lightPos.y*lightPos.y);
		ligPos.y = 10 - sqrt(ligPos.x*lightPos.x + lightPos.z*lightPos.z);
		ligPos.x = 10 - sqrt(ligPos.z*lightPos.z + lightPos.x*lightPos.x);
