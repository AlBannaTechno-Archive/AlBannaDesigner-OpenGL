...
///	Shader lampShader("shaders\\BasicColorLamp.vs", "shaders\\BasicColorLamp.frag");
	...
	Shader lightingShader("shaders\\BasicColorLightingNormMat.vs", "shaders\\BasicColorLightingNormMat.frag");
	Shader lampShader("shaders\\BasicColorLamp.vs", "shaders\\BasicColorLamp.frag");

	GLfloat vertices[] = {//the last three valus of every step is vec3 of the perpendicular vector on the surface
	...
	//std::cout << mms;
	GLfloat CopVer[6*6*6];
	AutoCopyArray(vertices,CopVer,6*6*6);
	ScallerVertex(vertices, 6 * 6 * 6, 0.6f);
