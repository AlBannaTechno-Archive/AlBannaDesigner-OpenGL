...
int main()
{
	...
	CBShader shader("shaders\\TransNo2.vs", "shaders\\TransNo2.frag");
	...
	GLfloat MyBordeColor[] = { 0.3f, 0.4f, 0.5f, 0.6f };
	...
	//	GLuint genrotLoca = glGetUniformLocation(shader.Program, "generalrot");
	//	generalrot = glm::translate(generalrot,glm::vec3(0.5f,0.7f,-2.0f));
	//	generalrot = glm::rotate(generalrot,(GLfloat)(10*glfwGetTime()), glm::vec3(1.0f, 0.0f, 0.0f));

	//	glUniformMatrix4fv(transLoca,1,GL_FALSE,glm::value_ptr(trans));
	//	model = glm::translate(model,glm::vec3(0.3,0.5,0.4));
	//	model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
	//	view = glm::rotate(view, ((GLfloat)(glfwGetTime())*20.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		view = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f));

	//	view = glm::rotate(view,(GLfloat)(40*glfwGetTime()),glm::vec3(0.0f,0.0f,1.0f));
		model = glm::rotate(model, -55.0f, glm::vec3(1.0f, 0.0f, 0.0f));
		//model = glm::rotate(model, ((GLfloat)(glfwGetTime())*20.0f), glm::vec3(1.0f, 1.0f, 1.0f));
	...
	//	glUniformMatrix4fv(projLoca, 1, GL_FALSE, glm::value_ptr(generalrot));
		...
		model2 = glm::rotate(model2, 30.0f, glm::vec3(1.0f, 1.0f, 1.0f));


		glUniformMatrix4fv(modelLoca, 1, GL_FALSE, glm::value_ptr(model2));
		glUniformMatrix4fv(viewLoca, 1, GL_FALSE, glm::value_ptr(view2));
		glUniformMatrix4fv(projLoca, 1, GL_FALSE, glm::value_ptr(proj2));
		glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
